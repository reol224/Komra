...
const testLogger = {
  ...
  fail: (name: string, error: string) =>
    isVerbose && console.log(`  ❌ FAILED: ${name} - ${error}`),
...
describe("Waitlist Page - Comprehensive Test Suite", () => {
  ...
  describe("Rendering & Initial State", () => {
    ...
    it("should render the hero section with tagline", () => {
      ...
      expect(
        screen.getByText(/Pre-Launch • Join the Waitlist/),
      ).toBeInTheDocument();
    ...
    it("should render all optional form fields", () => {
      ...
      expect(
        screen.getByPlaceholderText(
          /Tell us about your current security pain points/,
        ),
      ).toBeInTheDocument();
    ...
    it("should render the solution section", () => {
      ...
      expect(
        screen.getByText(/Enterprise security at SMB prices/),
      ).toBeInTheDocument();
  ...
  describe("Form Input Handling", () => {
    ...
    it("should update use case textarea on input", async () => {
      ...
      const useCaseInput = screen.getByPlaceholderText(
        /Tell us about your current security pain points/,
  ...
  describe("Form Submission & API Integration", () => {
    ...
    it("should handle duplicate email gracefully", async () => {
      ...
      testLogger.info(
        "Duplicate email treated as success (already on waitlist)",
      );
  ...
  describe("Success State", () => {
    ...
    it("should display success message after submission", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText("You're on the list!")).toBeInTheDocument();
        expect(
          screen.getByText(/Thank you for joining the Komra waitlist/),
        ).toBeInTheDocument();
      });
    ...
    it("should hide the form after successful submission", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.queryByPlaceholderText("Enter your last name"),
        ).not.toBeInTheDocument();
        expect(
          screen.queryByPlaceholderText("your.email@company.com"),
        ).not.toBeInTheDocument();
      });
  ...
  describe("Edge Cases & Error Handling", () => {
    ...
    it("should handle network timeout errors", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Network request timed out"),
        ).toBeInTheDocument();
      });
  ...
  describe("Accessibility", () => {
    ...
    it("should have proper labels for form inputs", () => {
      ...
      testLogger.info(
        "All form inputs have placeholder text for accessibility",
      );
